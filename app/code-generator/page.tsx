...
#include "credentials.h"  // WiFi, API, and DEVICE_ID for this station
#include <WiFi.h>
...
// TFT Display Pins (SPI) - per Hardware Wiring Guide
...
#define TFT_DC_PIN 14             // TFT DC → GPIO14
...
#define STATUS_LED_PIN 19         // Status LED → GPIO19
...
#define I2C_SCL_PIN 47            // RTC SCL → GPIO47
...
// Global system state is defined in the main .ino file
 ...
 * 6. Open credentials.h and set:
 *    - WIFI_SSID and WIFI_PASSWORD
 *    - DASHBOARD_URL
 *    - API_KEY for ${stationId}: ${apiKey}
 *    - DEVICE_ID to "${stationId}"
 * 7. Save both files
 * 8. Upload to your ESP32-S3 device
 * 
